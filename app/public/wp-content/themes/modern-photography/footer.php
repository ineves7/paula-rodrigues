...
<footer>
  ...
  <div class="galeria">
    ...
    <div class="galeria-item item1">
      <img src="<?php echo esc_url( $fotogaleria1 ); ?>" alt="Foto Galeria 1">
    </div>
    <div class="galeria-item item2">
      <img src="<?php echo esc_url( $fotogaleria2 ); ?>" alt="Foto Galeria 2">
    </div>
    <div class="galeria-item item3">
      <img src="<?php echo esc_url( $fotogaleria3 ); ?>" alt="Foto Galeria 3">
    </div>

    <!-- Segunda linha -->
    <div class="galeria-item item4">
      <img src="<?php echo esc_url( $fotogaleria4 ); ?>" alt="Foto Galeria 4">
    </div>
    <div class="galeria-item item5">
      <img src="<?php echo esc_url( $fotogaleria5 ); ?>" alt="Foto Galeria 5">
    </div>
    <div class="galeria-item item6">
      <img src="<?php echo esc_url( $fotogaleria6 ); ?>" alt="Foto Galeria 6">
    </div>
  </div> <!-- .galeria -->
